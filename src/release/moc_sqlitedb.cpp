...
static const char qt_meta_stringdata_DBBrowserDB[] = {
    "DBBrowserDB\0sqlExecuted(QString,int)\0"
    "sql,msgtype\0\0dbChanged(bool)\0dirty\0"
};
...
const QMetaObjectExtraData DBBrowserDB::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject DBBrowserDB::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_DBBrowserDB,
      qt_meta_data_DBBrowserDB, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &DBBrowserDB::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_DBBrowserDB))
