...
static const char qt_meta_stringdata_QsciScintillaQt[] = {
...
const QMetaObjectExtraData QsciScintillaQt::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject QsciScintillaQt::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QsciScintillaQt,
      qt_meta_data_QsciScintillaQt, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &QsciScintillaQt::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QsciScintillaQt))
